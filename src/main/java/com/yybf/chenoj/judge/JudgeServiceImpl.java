...
import com.yybf.chenoj.judge.codesandbox.CodeSandboxFactory;
import com.yybf.chenoj.judge.codesandbox.CodeSandboxProxy;
...
import com.yybf.chenoj.judge.strategy.DefaultJudgeStrategy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        boolean update = questionSubmitService.updateById(questionSubmitUpdateStatus);
        if (!update) {
        ...
        update = questionSubmitService.updateById(questionSubmitUpdateStatus);
        if (!update) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "题目状态更新错误");
        }
        // 查询到对应的执行结果并输出
